(() => {
  ...
  function extractMainHTML(html) {
    ...
    if (!open) return null;
    const start4 = open.index + open[0].length;
    return sliceMatchingClose(str, start4, open[1]);
  }
  ...
  function sliceMatchingClose(str, start4, tag) {
    ...
    while (i < str.length && depth > 0) {
      ...
      depth -= 1;
      if (depth === 0) return str.slice(start4, nextClose);
